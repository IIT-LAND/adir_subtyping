...
# scatterplot
p_disc = ggplot(data = df2use, aes(x = dbaes_atotal, y = dbaes_btotal, colour = factor(subgrp))) + geom_point() + xlab("Social-Communication") + ylab("Restricted Repetitive Behaviors") + ggtitle("NDAR Discovery") + ylim(0,1) + xlim(0,1) + scale_colour_manual(values = colors2use)
p_disc

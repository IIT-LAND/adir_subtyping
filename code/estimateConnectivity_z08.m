function estimateConnectivity_z08(corType,MOTTHRESH, rho)
%
...
scanInfoFile = fullfile(rootpath,'asd_subgrp_data_rsfmri_ALL_DSM5_diffzscoreGrps_z0.8.csv');
...
if DOPARTIALCORR
    ...
    elseif ~MOTCENSOR
        fname2save = fullfile(result_dir,sprintf('partialCorData_ridge_lambda%d.diffzscoreGrps_z0.8.txt',rho));
    end % if MOTCENSOR
end % DOPARTIALCORR

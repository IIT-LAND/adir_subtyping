...
<!-- colors2use = c(ggcolors[1],ggcolors[1],ggcolors[1],ggcolors[2],ggcolors[3],ggcolors[3]) -->
<!-- p = ggplot(data = df4plot, aes(x = variable, -->
<!--                                y = value, -->
<!--                                colour = subgrp, -->
<!--                                group = subjectkey)) + facet_grid(. ~ subgrp) -->
...
<!-- ggcolors = get_ggColorHue(3) -->
<!-- colors2use = c(ggcolors[1],ggcolors[1],ggcolors[1],ggcolors[1],ggcolors[2],ggcolors[3],ggcolors[3]) -->
<!-- p = ggplot(data = df4plot, aes(x = variable, -->
<!--                                y = value, -->
<!--                                colour = subgrp, -->
<!--                                group = subjectkey)) + facet_grid(. ~ subgrp) -->
...
<!-- df2use = data.frame(df2use) -->
<!-- df2use$subjectkey = factor(df2use$subjectkey) -->
<!-- # df2use$SC = df2use$dbaes_atotal/maxScores[1] -->
<!-- # df2use$RRB = df2use$dbaes_btotal/maxScores[2] -->
<!-- #******************************************** -->
<!-- df2use$SC = df2use$dbaes_atotal -->
<!-- df2use$RRB = df2use$dbaes_btotal -->
<!-- #******************************************** -->
...
<!-- # scatterplot -->
<!-- p_disc = ggplot(data = Dverbal_Discovery, aes(x = dbaes_atotal/maxScores[1], y = dbaes_btotal/maxScores[2], colour = factor(hc_subgrp))) + geom_point() + xlab("Social-Communication") + ylab("Restricted Repetitive Behaviors") + ggtitle("NDAR Discovery") -->
<!-- p_disc -->
...
<!-- # scatterplot -->
<!-- p_rep = ggplot(data = Dverbal_Replication, aes(x = dbaes_atotal/maxScores[1], y = dbaes_btotal/maxScores[2], colour = factor(hc_subgrp))) + geom_point() + xlab("Social-Communication") + ylab("Restricted Repetitive Behaviors") + ggtitle("NDAR Replication") -->
<!-- p_rep -->
...
<!-- p_disc = ggplot(data = Dverbal_Discovery, aes(x = dbaes_atotal/maxScores[1], y = dbaes_btotal/maxScores[2], colour = factor(nbclust_subgrp))) + geom_point() + xlab("Social-Communication") + ylab("Restricted Repetitive Behaviors") + ggtitle("NDAR Discovery") -->
<!-- p_disc -->
...
<!-- p_rep = ggplot(data = Dverbal_Replication, aes(x = dbaes_atotal/maxScores[1], y = dbaes_btotal/maxScores[2], colour = factor(nbclust_subgrp))) + geom_point() + xlab("Social-Communication") + ylab("Restricted Repetitive Behaviors") + ggtitle("NDAR Replication") -->
<!-- p_rep -->
